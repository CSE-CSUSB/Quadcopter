...
class Throttle:
	...
	# stops motor and releases GPIO control is cleanup parameter is true
	def throttleEnd(self, cleanup):
		self.__throttle.ChangeDutyCycle(self.__minThrottle) #stop motor
